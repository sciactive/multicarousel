...
var template = (function () {
  return {
    oncreate () {
      ...
      this.__width = (100 / count)+"%";
      for (let i = 0; i < items.length; i++) {
        this.refs.items.appendChild(items[i]);
        items[i].style.width = this.__width;
      }
      for (let i = 0; i < count; i++) {
        items[i].classList.add("active");
      }
      this.__transition = "left "+(this.get("transition") / 1000)+"s";
      this.refs.items.style.left = "0";
      this.refs.items.style.transition = this.__transition;
    ...
    methods: {
      get __transitioning() {
        return this.get("__transitioning");
      },
      set __transitioning(val) {
        return this.set({"__transitioning": val});
      },
      get __width() {
        return this.get("__width");
      },
      set __width(val) {
        return this.set({"__width": val});
      },
      get __timer() {
        return this.get("__timer");
      },
      set __timer(val) {
        return this.set({"__timer": val});
      },
      get __transition() {
        return this.get("__transition");
      },
      set __transition(val) {
        return this.set({"__transition": val});
      },
      next () {
        if (this.__transitioning) return;
        this.__transitioning = true;
        ...
        this.refs.items.style.transition = this.__transition;
        this.refs.items.style.left = "-"+this.__width;
      ...
      start () {
        if (this.get("delay") > 0) {
          if (this.__timer) this.pause();
          this.__timer = setInterval(this.next.bind(this), this.get("delay"));
        }
      }
    }
  };
...
function add_css () {
	...
	style.id = "svelte-606669999-style";
	style.textContent = "\n  [svelte-606669999].multicarousel, [svelte-606669999] .multicarousel {\n    position: relative;\n    overflow: hidden;\n    white-space: nowrap;\n  }\n  [svelte-606669999].previous, [svelte-606669999] .previous, [svelte-606669999].next, [svelte-606669999] .next, [svelte-606669999].pause, [svelte-606669999] .pause, [svelte-606669999].start, [svelte-606669999] .start {\n    position: absolute;\n    cursor: pointer;\n    display: flex;\n    z-index: 1;\n    fill: #fff;\n  }\n  [svelte-606669999].previous, [svelte-606669999] .previous, [svelte-606669999].next, [svelte-606669999] .next {\n    width: 30px;\n    align-items: center;\n    height: 100%;\n  }\n  [svelte-606669999].previous, [svelte-606669999] .previous {\n    left: 0;\n    justify-content: flex-end;\n  }\n  [svelte-606669999].next, [svelte-606669999] .next {\n    right: 0;\n    justify-content: flex-start;\n  }\n  [svelte-606669999].pause, [svelte-606669999] .pause, [svelte-606669999].start, [svelte-606669999] .start {\n    width: 28px;\n    left: 50%;\n    margin-left: -14px;\n    height: 30px;\n    bottom: 0;\n    justify-content: center;\n    align-items: flex-start;\n  }\n  [svelte-606669999].items, [svelte-606669999] .items {\n    white-space: nowrap;\n    position: relative;\n  }\n  [svelte-606669999].items > *, [svelte-606669999] .items > * {\n    display: none;\n  }\n  [svelte-606669999].items > *.active, [svelte-606669999] .items > *.active {\n    display: inline-block;\n  }\n";
	appendNode( style, document.head );
}

function create_main_fragment ( state, component ) {
	var div = createElement( 'div' );
	setAttribute( div, 'svelte-606669999', '' );
...
function MultiCarousel ( options ) {
	...
	if ( !document.getElementById( "svelte-606669999-style" ) ) add_css();
...
function assign ( target ) {
	for ( var i = 1; i < arguments.length; i += 1 ) {
		...
		for ( var k in source ) Object.defineProperty(target, k, Object.getOwnPropertyDescriptor(source, k));
	}
